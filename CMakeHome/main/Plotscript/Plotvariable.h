...
class Plotvariable {
    public:
        ...
        Plotvariable(std::string name, TTree* tree, std::string legendname, std::vector<Plotvariable*> *Plotvector);                      //no cuts
        Plotvariable(std::string name, TTree* tree, std::string legendname, std::string cuts, std::vector<Plotvariable*> *Plotvector);    //with cuts
