...
class Value_w_Err {
    public:
        ...
        Value_w_Err & operator=(Value_w_Err const& value_w_err) {                                         //Equal
            this-> SetVal(value_w_err.GetVal());
            this-> SetError(value_w_err.GetError());
        ...
        void SetVal(double value) { _value = value; }
        void SetError(double error) { _lowerror = error; _uperror = error; _symmetric = true; }
