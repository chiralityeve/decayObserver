...
// -----------------------------------------------------------------------
    ...
    RooRealVar peak_yield("peak_yield", "Yield des Signal-Peaks", 2000, 300, 8000);                                          //Definiere Yield (Anz. Events im Gauss)
    ...
    RooRealVar background_yield("bkgrd_yield", "Yield des Background", 400, 50, 1000);
    ...
    TFile* f = new TFile("../plots/Fits_after_BDT/Signalfit_Bs2Jpsif2_CB_triggered_afterBDT_punzi.root", "RECREATE");
    
    //CreateRooPlot object with Mass on the (x) axis
    RooPlot* DMassFrame = Bs_M.frame(Bins(50), Name("Masse"), Title("Signalfit Resonant Decay B_{s} -> J/#psi f_{2} | Punzicut"));
    ...
    DMassFrame -> SetAxisRange(1, 1000, "Y");
    DMassCanvas->SetLogy(1);
    DMassFrame -> Write();
    
    DMassCanvas->SaveAs("../plots/Fits_after_BDT/Signalfit_Bs2Jpsif2_CB_triggered_afterBDT_punzi_logy.png");
    ...
    DMassCanvas->SaveAs("../plots/Fits_after_BDT/Signalfit_Bs2Jpsif2_CB_triggered_afterBDT_punzi.png");
