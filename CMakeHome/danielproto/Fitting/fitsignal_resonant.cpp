...
// -----------------------------------------------------------------------
    ...
    RooRealVar background_yield("bkgrd_yield", "Yield des Background", 250000, 150000, 350000);
    ...
    TFile* f = new TFile("../plots/Fitplots/Signalfit_Bs2Jpsif2.root", "RECREATE");
    ...
    DMassFrame -> SetMaximum(10000);
    DMassFrame -> SetMinimum(3000);
    DMassCanvas->SetLogy(1);
    DMassFrame -> Write();
    DMassCanvas->SaveAs("../plots/Fitplots/Signalfit_Bs2Jpsif2.png");
