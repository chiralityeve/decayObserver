...
// -----------------------------------------------------------------------
    ...
    //Cuts anwenden
    std::string punzicut = "TMVAResponse > 0.152508";
    ...
    TFile* f = new TFile("../plots/BDTrareDecay_Fits/Bkgrfit_Sigregion_extrap_Commoncut.root", "RECREATE");
    ...
    DMassFrame->Draw();
    DMassCanvas -> SaveAs("../plots/BDTrareDecay_Fits/Bkgrfit_Sigregion_extrap_Common.png");
