...
int main( int argc, char** argv )
{
    ...
    */
    ...
    if(arg1 == "training") {
        ...
        cut_common = get_BDTcut_common(outfile[0], nSig, nBkg);
        cut_punzi1 = get_BDTcut_punzi(outfile[0], 1, nBkg);
        cut_punzi2 = get_BDTcut_punzi(outfile[0], 2, nBkg);
        cut_punzi3 = get_BDTcut_punzi(outfile[0], 3, nBkg);
        cut_punzi4 = get_BDTcut_punzi(outfile[0], 4, nBkg);              
        cut_punzi5 = get_BDTcut_punzi(outfile[0], 5, nBkg);
