...
int main( int argc, char** argv )
{
 ...
 //  gROOT->SetStyle("Plain");
  gROOT->ProcessLine(".x /afs/cern.ch/work/c/clinn/macros/lhcbStyle.C");
   ...
   double nResoSig2012 = 45904., nResoBkg2012 = 4657.;
   double nResoSig2011 = 21203., nResoBkg2011 = 2119.;


   TString fname1 = "/afs/cern.ch/work/c/clinn/phimumu/phimumu_2012_presel_probnn_sweight.root";
   TString fname2 = "/afs/cern.ch/work/c/clinn/phimumu/phimumu_2011_presel_probnn_sweight.root";
   TFile *input1 = TFile::Open( fname1 );
   TFile *input2 = TFile::Open( fname2 );
   TTree *signal1     = (TTree*)input1->Get("jpsiphi");
   TTree *background1 = (TTree*)input1->Get("bkg_large");
   TTree *signal2     = (TTree*)input2->Get("jpsiphi");
   TTree *background2 = (TTree*)input2->Get("bkg_large");
...
//=== TMVA Selection 2012 ===========================================
   ...
   factory1->AddBackgroundTree( background1, 1.0 );
   ...
   double cutReso2012 = get_BDTcut(outfile[0], nResoSig2012, nResoBkg2012);
