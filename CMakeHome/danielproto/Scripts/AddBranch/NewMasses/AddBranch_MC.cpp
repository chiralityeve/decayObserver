...
int main(){
    ...
    //TFile fin("/afs/cern.ch/work/d/dberning/private/Pruned/MC/MC_merged_pruned.root", "READ");
    ...
    //TFile fout("/afs/cern.ch/work/d/dberning/private/Pruned/MC/MC_merged_pruned_newVars.root", "RECREATE");
    TFile fout("/afs/cern.ch/work/d/dberning/private/RawData/Bsf2mumu_MC_Full_newVars.root", "RECREATE");
    ...
    //Get Branches of old Tree and (new) Tree
