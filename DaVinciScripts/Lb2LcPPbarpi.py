...
########################################################################
decay = "[Lambda_b~0 -> ^(Lambda_c~- -> ^p~- ^K+ ^pi-) ^(a_1(1260)+ -> ^p+ ^p~- ^pi+)]CC"
########################################################################
LambdaBOfflineTree = DecayTreeTuple("LambdaBOfflineTree")
#data 
LambdaBOfflineTree.Inputs = ["/Event/Bhadron/Phys/Lb2LcppbarPiLc2PKPiBeauty2CharmLine/Particles"]
#LambdaBOfflineTree.Inputs = ["/Event/AllStreams/Phys/B2D0D0KBeauty2CharmLine/Particles"] # MC
...
LambdaBOfflineTree.Branches["lab0"] = "[Lambda_b~0 -> (Lambda_c~- -> p~- K+ pi-) (a_1(1260)+ -> p+ p~- pi+)]CC"
#-- 
...
DaVinci().TupleFile = "LambdaB2LcPPpi.root"
DaVinci().Lumi = True
DaVinci().DDDBtag    = "dddb-20130111"
DaVinci().CondDBtag    = "cond-20130114"
if DaVinci().Simulation :
    DaVinci().DDDBtag    = "Sim08-20130503-1"
    DaVinci().CondDBtag    = "Sim08-20130503-1-vc-md100" # mag down
    #DaVinci().CondDBtag    = "Sim08-20130503-1-vc-mu100" # mag up
#endif    
